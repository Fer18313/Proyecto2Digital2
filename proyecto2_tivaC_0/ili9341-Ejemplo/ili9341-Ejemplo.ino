...
const int P1_UP = PE_3;
const int P1_DOWN = PF_1;
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(c1), b1, RISING);
  attachInterrupt(digitalPinToInterrupt(c2), b2, RISING);
...
void b1(){
  ...
  switch(counter){
    case 1:
    SD_read(0,0,320,240,"stuff.txt");
    break;
    case 2:
    SD_read(0,0,320,240,"stuff2.txt");
    break;
    case 3:
    SD_read(0,0,320,240,"stuff3.txt");
    break;
  }
}
...
void SD_read(unsigned int x, unsigned int y, unsigned int width, unsigned int height, char * archivo){
